...
class SurveysController extends CosapiController
{
  ...
  protected function query_surveys($fecha_evento, $events)
  {
    ...
    $query_surveys['survey']  = DB::select("exec sp_list_surveys :start_date, :end_date, :id_tipo_encuesta", [
      'start_date'=>$days[0] ,
      'end_date'=>$days[1],
      'id_tipo_encuesta'=>$events_id
    ]);
    $survey_detail = DB::select("exec sp_list_surveys_detail :start_date, :end_date, :id_tipo_encuesta",[
      'start_date'=>$days[0] ,
      'end_date'=>$days[1],
      'id_tipo_encuesta'=>$events_id
    ]);
