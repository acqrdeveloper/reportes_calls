...
Route::group(['middleware' => ['user']], function () {
  ...
  Route::post('form_create_sound_massive', ['uses' => 'SoundMassiveController@formCreate']);
  Route::post('create_sound_massive', ['uses' => 'SoundMassiveController@create']);
  Route::post('form_edit_sound_massive', ['uses' => 'SoundMassiveController@formEdit']);
  Route::post('edit_sound_massive', ['uses' => 'SoundMassiveController@update']);
  Route::post('form_delete_sound_massive', ['uses' => 'SoundMassiveController@formDelete']);
  Route::post('delete_sound_massive', ['uses' => 'SoundMassiveController@delete']);
